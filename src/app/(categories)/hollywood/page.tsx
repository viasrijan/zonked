...
export const metadata: Metadata = {
  title: "Hollywood",
  description: "Latest Hollywood news, celebrity gossip, movie releases and entertainment updates.",
};

export default async function HollywoodPage() {
  const [articles, trending] = await Promise.all([
    getArticlesByCategory("hollywood", 30),
