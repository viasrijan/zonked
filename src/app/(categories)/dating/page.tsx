...
export const metadata: Metadata = {
  title: "Dating",
  description: "Dating advice, relationship tips, and love stories.",
};
...
export default async function CategoryPage() {
  ...
  const articles = allArticles.filter((a: any) => a.category === "dating");
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8">
      <div className="mb-8 border-b border-gray-200 pb-6">
        <h1 className="text-5xl font-black tracking-[-0.03em] md:text-6xl" style={{ color: "#F15946" }}>
          Dating
        </h1>
        <p className="mt-2 text-lg text-gray-500">Dating advice, relationship tips, and love stories.</p>
      </div>
