...
export const metadata: Metadata = {
  title: "South Cinema",
  description: "Latest Tamil, Telugu, Kannada, Malayalam cinema news, updates and celebrity gossip.",
};

export default async function SouthCinemaPage() {
  const [articles, trending] = await Promise.all([
    getArticlesByCategory("south-cinema", 30),
